...
public class Cashier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setFont(new java.awt.Font("Modern No. 20", 0, 20)); // NOI18N
        ...
        CashierTable.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
    ...
    private void table_update()
    {
        try {
            ...
            try {
                ...
                DefaultTableModel d = (DefaultTableModel)CashierTable.getModel();
                d.setRowCount(0);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Username Successfully Saved");
            table_update();            
            txtuser.setText("");
            txtpass.setText("");
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        DefaultTableModel d1 = (DefaultTableModel)CashierTable.getModel();
        int selectIndex = CashierTable.getSelectedRow();
        ...
        try {
            ...
            pst.setInt(4, id);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Username Successfully Edited");
            table_update();            
            txtuser.setText("");
            txtpass.setText("");
            txtstatus.setSelectedIndex(-1);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "Do You want to delete this username?","Warning..!!", JOptionPane.YES_NO_OPTION);
